              ...
              <div className="bg-muted/20 p-4 rounded-lg">
                ...
                <div className="flex items-center justify-between">
                  ...
                  {loading ? <Loader className="animate-spin text-blue-500 h-9 w-9 mx-2" /> :
                    <>
                      {user ?
                        <Button type="submit" className="bg-primary text-primary-foreground px-4 py-2 rounded-md w-32">
                          Post
                        </Button> :
                        <Link href="/login">
                          <Button type="button" className="bg-primary text-primary-foreground px-4 py-2 rounded-md w-32">
                            Login to post
                          </Button>
                        </Link>
                      }
